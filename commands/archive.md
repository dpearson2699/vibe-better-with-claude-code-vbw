...
2. **No milestones or roadmap:** If neither ACTIVE nor ROADMAP.md exists, STOP: "No milestones configured. Run /vbw:implement to set up your project."
3. **Audit not passed:** If `--force` not present, run audit checks (same as /vbw:audit). If FAIL, STOP: "Audit failed. Run /vbw:audit for details, or --force to archive anyway."
...
- Archive Confirmation template (double-line box)
